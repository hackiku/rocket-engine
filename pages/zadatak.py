...
def main():
  ...
  Pa = st.number_input('2. Atmosferski pritisak (Pa)', value=101325.0)
  F = st.number_input('Sila potiska', value = 2200)
  epsilon_i = st.number_input('Stepen sirenja mlaznika (epsilon_i)', value=7.0)
  d_dkdr = st.number_input('Odnos precnika komore i grla mlaznika (d_dkdr)', value=3)
